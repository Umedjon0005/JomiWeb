...
const MomentsGallery = ({ moments = [] }) => {
  ...
  return (
    <section className="relative py-24 bg-gradient-to-br from-[#fdf2f8] via-white to-[#ecfeff] overflow-hidden">
      <div className="absolute inset-y-10 -right-20 w-64 h-64 bg-[#87CEEB]/20 blur-[120px]" />
      <div className="absolute inset-y-0 -left-20 w-72 h-72 bg-[#c084fc]/15 blur-[120px]" />
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
          <div>
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold text-gray-900">
              Scenes From Every Corridor
            </h2>
            <p className="text-gray-600 mt-4 max-w-2xl">
              Drag sideways or use your trackpad to glide through candid campus
              snapshots. Each panel opens up a different corner of Aurora
              Boarding School.
            </p>
          </div>
          <div className="text-sm text-gray-600">
            <span className="font-semibold text-gray-900">Tip:</span> Horizontal
            scroll reveals more moments.
          </div>
        </div>
          ...
          <div className="flex gap-6 min-w-[600px] snap-x snap-mandatory">
            {displayItems.map((moment, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <p className="text-xs uppercase tracking-[0.4em] text-[#7dd3fc] mb-2">
